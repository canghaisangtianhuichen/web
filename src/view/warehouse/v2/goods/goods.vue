  ...
  <div>
    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        <el-button type="primary" icon="plus" @click="temCustomer">新增货物</el-button>
      </div>
      <el-table
        :data="tableData"
        row-key="id"
          ...
          <template #default="scope">
            <el-popover v-model="scope.row.visible" placement="top" width="160">
              ...
              <div style="text-align: right; margin-top: 8px;">
                ...
                <el-button type="primary" @click="deleteGoodFunc(scope.row)">确定</el-button>
              </div>
              <template #reference>
...
const deleteGoodFunc = async(row) => {
  const res = await deleteGood({ name: row.name, warehouseId: row.warehouseId })
  if (res.code === 0) {
